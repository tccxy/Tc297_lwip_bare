 ...
 *
 * \defgroup IfxLld_Demo_Eth_SrcDoc_InterruptConfig Interrupt configuration
 * \ingroup IfxLld_Demo_Eth_SrcDoc
 */
...
/**
 * \addtogroup IfxLld_Demo_Eth_SrcDoc_InterruptConfig
 * \{ */
